...
import com.mobstac.thehindubusinessline.fragments.SlidingPortfolioArticleFragment;
 ...
 */
public class SectionLandingPortfolioAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SectionLandingPortfolioAdapter(Context ctxParam, ArrayList<SectionAdapterItem> mArticleList,
                                          String sectionName, String sectionType, String outBrainLink,
                                          boolean isFromPortfolioScreen, boolean isNetworkAvailable) {
        mContext = ctxParam;
        isFromPortfolio = isFromPortfolioScreen;
...
//                fillNativeAdData(nativeAdViewHolder, position);
                ...
                break;
            case SectionAdapterItem.VIEW_INLINE_AD:
                SectionLandingPortfolioAdapter.InlineAdViewHolder inlineAdViewHolder = (SectionLandingPortfolioAdapter.InlineAdViewHolder) holder;
    ...
    public int getItemCount() {
       // return mSectionArticleList.size();
...
/*
    ...
    public class InlineAdViewHolder extends RecyclerView.ViewHolder {
        ...
        public InlineAdViewHolder(View itemView) {
            super(itemView);
            mNativeAdContainer = (FrameLayout) itemView.findViewById(R.id.nativeAdLayout);
        }
    }
*/
        ...
        if (mSectionArticleList.size() > 0) {
            ...
            articleHolder.mParentView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    SlidingPortfolioArticleFragment fragment = SlidingPortfolioArticleFragment.newInstance(
            ...
            articleHolder.mMultimediaButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    GoogleAnalyticsTracker.setGoogleAnalyticsEvent(mContext, "SectionLanding", "SectionLanding: Article Clicked", "Section landing Fragment");
                    FlurryAgent.logEvent("SectionLanding: " + " Article Clicked");
                    SlidingPortfolioArticleFragment fragment = SlidingPortfolioArticleFragment.newInstance(mSectionArticleList.get(position).getArticleActualPos(), bean.getSid(), false);
                    ((AppCompatActivity) mContext).getSupportFragmentManager().beginTransaction()
                            .replace(R.id.FRAME_CONTENT, fragment).addToBackStack(null).commit();
                }
            });
            ...
            if (isFragmentVisible()) {
                ...
                mInlineAdView.setAdListener(new AdListener() {
                    ...
                    public void onAdFailedToLoad(int errorCode) {
                        adsReqIndex.put(position, false);
                        Log.i("Ads", "onAdFailedToLoad Portfolio kk :- " + errorCode);
...
//        mNativeAdView = null;
    ...
    public void setUpdatedListToHomeAdapter(ArrayList<ArticleDetail> mArticleList) {
        ...
        this.mSectionArticleList = (FeatureConstant.getSectionRevisedData(mSectionArticleList.size(), mArticleList, false));
...
//        staticPageUrl = "https://google.com"+"00#00"+"51";
            // Portfolio
        staticPageUrl = "https://google.com"+"00#00"+"86";
            // BLink
//            staticPageUrl = "https://google.com" + "00#00" + "78";

        } else { // Portfolio
            // Home
        staticPageUrl = "https://google.com"+"00#00"+"51";
            // Portfolio
//            staticPageUrl = "https://google.com" + "00#00" + "87";
            // BLink
//            staticPageUrl = "https://google.com" + "00#00" + "78";
        }*/
