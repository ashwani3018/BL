...
public class GoldFragment extends Fragment {
    ...
    private void initView(View view) {
        ...
        mProgress = (ProgressView) view.findViewById(R.id.progress_layout);
    ...
    private void getForexItem() {
        ...
        if (mGetForexDataTask == null) {
            ...
            mGetForexDataTask.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, Constants.GOLD_DOLLAR_URL);
