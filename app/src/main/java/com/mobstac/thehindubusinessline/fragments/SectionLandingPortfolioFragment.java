...
import com.mobstac.thehindubusinessline.adapter.SectionLandingPortfolioAdapter;
...
public class SectionLandingPortfolioFragment extends Fragment {
    ...
    private static final String ARG_PARAM5 = "from_portfolio";
    ...
    private SectionLandingPortfolioAdapter mSectionLandingAdapter;
    ...
    private OrderedRealmCollectionChangeListener<RealmResults<ArticleBean>> mOrderedRealmCollectionChangeListener = new OrderedRealmCollectionChangeListener<RealmResults<ArticleBean>>() {
        ...
        public void onChange(RealmResults<ArticleBean> articleBeen, OrderedCollectionChangeSet changeSet) {
            /*Log.i(TAG, "onChange: Size of Article Bean " + articleBeen.size());
            Log.i(TAG, "onChange: Section Name " + mSectionName);
    ...
    public static SectionLandingPortfolioFragment newInstance(long sectionId, String sectionType, String sectionName, String outbrainLink,
                                                              boolean isFromPortfolioScreen, String staticPageUrl, boolean isStaticPageEnable, int positionInListView) {
        SectionLandingPortfolioFragment fragment = new SectionLandingPortfolioFragment();
        ...
        args.putBoolean(ARG_PARAM5, isFromPortfolioScreen);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            isFromPortfolioScreen = getArguments().getBoolean(ARG_PARAM5);
...
//        addExtraView(mArticleList);
        ...
        ArrayList<SectionAdapterItem> sectionAdapterItems = FeatureConstant.getSectionRevisedData(0, mArticleData, false);
        mSectionLandingAdapter = new SectionLandingPortfolioAdapter(getActivity(), sectionAdapterItems, mSectionName,
                sectionType, mOutBrainLink, isFromPortfolioScreen, isNetworkAvailable);
