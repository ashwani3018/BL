...
import com.mobstac.thehindubusinessline.model.CompanyBseData;
import com.mobstac.thehindubusinessline.model.CompanyNseData;
...
public class GetQuoteFragment extends Fragment {
    ...
    public void onAttach(Context context) {
        ...
        stockDetailsActivity = (StockDetailsActivity) context;
//		companyBseDatas = stockDetailsActivity.companyBseDatas;
//		companyNseDatas = stockDetailsActivity.companyNseDatas;
    }

    @Override
    public void onAttach(Activity activity) {
        super.onAttach(activity);
        stockDetailsActivity = (StockDetailsActivity) activity;
//		companyBseDatas = stockDetailsActivity.companyBseDatas;
//		companyNseDatas = stockDetailsActivity.companyNseDatas;
    }
...
//                companyBseDatas = getArguments().getParcelableArrayList("bselist");
        ...
        GoogleAnalyticsTracker.setGoogleAnalyticScreenName(getActivity(), getString(R.string.ga_quotedetail_screen));
        FlurryAgent.logEvent(getString(R.string.ga_quotedetail_screen));
